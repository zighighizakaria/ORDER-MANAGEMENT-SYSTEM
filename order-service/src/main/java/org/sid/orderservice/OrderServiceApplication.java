...
public class  OrderServiceApplication
{
	...
	@Bean
	CommandLineRunner start(ProductItemRepository productItemRepository, OrderRepository orderRepository, CustomerRestClientService customerRestClientService, InventoryRestClientService inventoryRestClientService)
	{
		return args ->
		{
